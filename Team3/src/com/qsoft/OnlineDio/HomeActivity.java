...
public class HomeActivity extends Activity implements AdapterView.OnItemClickListener {
    public static final String[] titles = new String[]{"Sound Of Silence",
            "Sound Of Silence", "Sound Of Silence", "Sound Of Silence"};

    public static final String[] names = new String[]{
            "Khiemvx", "Khiemvx", "Khiemvx", "Khiemvx"};
    public static final Integer[] likes = new Integer[]{122, 246, 246, 246};
    public static final Integer[] comments = new Integer[]{132, 246, 246, 246};
    public static final String[] times = new String[]{
            "a day ago", "a day ago", "a day ago", "a day ago"};
    public static final Integer[] avatars = {R.drawable.ic_launcher,
