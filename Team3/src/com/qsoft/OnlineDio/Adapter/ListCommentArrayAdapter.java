 ...
 * Date: 10/18/13
 */
public class ListCommentArrayAdapter extends ArrayAdapter<CommentModel>
{
    private Context context;

    public ListCommentArrayAdapter(Context context, int resourceId, List<CommentModel> objects)
    {
