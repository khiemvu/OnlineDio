...
//import com.qsoft.OnlineDio.HomeModel;
//
...
//            String text = "home_bt_navigate click... should be implemented";
//            Toast.makeText(HomeActivity.this, text, Toast.LENGTH_LONG).show();
//            if (position == 2)
//            {
//                Intent intent = new Intent(HomeActivity.this, ProgramFragment.class);
